...
rdd_distinct_tags=rdd_tags.distinct() #Step 4
...
def save_to_db(list_of_tuples):
    ...
    for tupl in list_of_tuples:
      ...
      #update_stmt = "insert into title_tags values (" + imdb_id_str.encode('utf-8') + "," + tag.encode('utf-8') + ")" 
      #print "update_stmt = " + update_stmt + "\n"

      update_stmt = "insert into title_tags values (%s, %s)" 
